...
|-------|--------|---|----|---|------|----|------|---|----|---|----|-----|
| [TracerProvider](specification/trace/api.md#tracerprovider-operations) |  | Go |  |  |  |  |  |  |  |  |  |  |
...
| [Trace / Context interaction](specification/trace/api.md#context-interaction) |  | Go |  |  |  |  |  |  |  |  |  |  |
| Get active Span |  | N/A | + |  | + |  |  |  |  |  |  |  |
| Set active Span |  | N/A | + |  | + |  |  |  |  |  |  |  |
| [Tracer](specification/trace/api.md#tracer-operations) |  | Go |  |  |  |  |  |  |  |  |  |  |
| Create a new Span |  | + | + |  | + |  |  |  |  |  |  |  |
| Documentation defines adding attributes at span creation as preferred |  | - | - |  | + |  |  |  |  |  |  |  |
| Get active Span |  | N/A | + | + | + | + | + | + | + | + | + | + |
| Mark Span active |  | N/A | + |  | + |  |  |  |  |  |  |  |
| Safe for concurrent calls |  | + | + |  | + |  |  |  |  |  |  |  |
| [SpanContext](specification/trace/api.md#spancontext) |  | Go |  |  |  |  |  |  |  |  |  |  |
| IsValid |  | + | + |  | + |  |  |  |  |  |  |  |
| IsRemote |  | + | + |  | + |  |  |  |  |  |  |  |
| Conforms to the W3C TraceContext spec |  | + | + |  | + |  |  |  |  |  |  |  |
| [Span](specification/trace/api.md#span) |  | Go |  |  |  |  |  |  |  |  |  |  |
| Create root span |  | + | + |  | + |  |  |  |  |  |  |  |
...
| [Span attributes](specification/trace/api.md#set-attributes) |  | Go |  |  |  |  |  |  |  |  |  |  |
| SetAttribute |  | + | + |  | + |  |  |  |  |  |  |  |
...
| [Span linking](specification/trace/api.md#specifying-links) |  | Go |  |  |  |  |  |  |  |  |  |  |
| Links can be recorded on span creation |  | + | + |  | + |  |  |  |  |  |  |  |
| Links can be recorded after span creation |  | + | - |  | + |  |  |  |  |  |  |  |
| Links order is preserved |  | + | + |  | + |  |  |  |  |  |  |  |
| [Span events](specification/trace/api.md#add-events) |  | Go |  |  |  |  |  |  |  |  |  |  |
| AddEvent |  | + | + |  | + |  |  |  |  |  |  |  |
| Add order preserved |  | + | + |  | + |  |  |  |  |  |  |  |
| Safe for concurrent calls |  | + | + |  | + |  |  |  |  |  |  |  |
| [Span exceptions](specification/trace/api.md#record-exception) |  | Go |  |  |  |  |  |  |  |  |  |  |
| RecordException |  | - | + |  | + |  |  |  |  |  |  |  |
| RecordException with extra parameters |  | - | + |  | + |  |  |  |  |  |  |  |
| [Sampling](specification/trace/sdk.md#sampling) |  | Go |  |  |  |  |  |  |  |  |  |  |
...
| Feature | Optional | Go | Java | JS | Python | Ruby | Erlang | PHP | Rust | C++ | .NET | Swift |
|-------|--------|---|----|---|------|----|------|---|----|---|----|-----|
| Environment Variable Support | X | Go |  |  |  |  |  |  |  |  |  |  |
| OTEL_SDK_DISABLED | X | - | + |  | + |  |  |  |  |  |  |  |
...
| Feature | Optional | Go | Java | JS | Python | Ruby | Erlang | PHP | Rust | C++ | .NET | Swift |
|-------|--------|---|----|---|------|----|------|---|----|---|----|-----|
| [Declarative Configuration](specification/configuration/README.md#declarative-configuration) 🚧 |  | Go |  |  |  |  |  |  |  |  |  |  |
...
| Feature | Optional | Go | Java | JS | Python | Ruby | Erlang | PHP | Rust | C++ | .NET | Swift |
|-------|--------|---|----|---|------|----|------|---|----|---|----|-----|
| [OTLP Exporters](specification/protocol/otlp.md) |  | Go |  |  |  |  |  |  |  |  |  |  |
| OTLP/gRPC Exporter |  | + | + |  | + |  |  |  |  |  |  |  |
| OTLP/HTTP binary Protobuf Exporter |  | + | + |  | + |  |  |  |  |  |  |  |
| OTLP/HTTP JSON Protobuf Exporter |  | + | - |  | - |  |  |  |  |  |  |  |
| OTLP/HTTP gzip Content-Encoding support | X | + | + |  | + |  |  |  |  |  |  |  |
| [Zipkin Exporters](specification/trace/sdk_exporters/zipkin.md) |  | Go |  |  |  |  |  |  |  |  |  |  |
| Zipkin V1 JSON | X | - | + |  | + |  |  |  |  |  |  |  |
| Zipkin V1 Thrift | X | - | + |  | - |  |  |  |  |  |  |  |
| Zipkin V2 JSON |  | + | + |  | + |  |  |  |  |  |  |  |
| Zipkin V2 Protobuf |  | - | + |  | + |  |  |  |  |  |  |  |
...
| Feature | Optional | Go | Java | JS | Python | Ruby | Erlang | PHP | Rust | C++ | .NET | Swift |
|-------|--------|---|----|---|------|----|------|---|----|---|----|-----|
| [OpenCensus Compatibility](specification/compatibility/opencensus.md) |  | Go |  |  |  |  |  |  |  |  |  |  |
...
| [OpenTracing Compatibility](specification/compatibility/opentracing.md) |  | Go |  |  |  |  |  |  |  |  |  |  |
